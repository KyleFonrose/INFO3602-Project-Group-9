...
<footer id="colophon" class="site-footer">
    <div class="container">
        <div class="row">
            ...
            <ul class="col-lg-12 col-sm-12 col-sm-12">
                ...
                <li><a href="<?php echo get_page_link( get_page_by_title("Contact Us")->ID ); ?>">CONTACT US</a></li>
                <?php
                echo
                '<li><a href="https://ferishak.sgedu.site/testimonials/">TESTIMONIALS</a></li>' ?>
            ...
            <?php
                ...
                if (!empty ( $button ) ): ?>
                    ...
                    <div class="col-lg-3 col-sm-3 col-sm-12 join_now">
                        <a href="<?php echo get_page_link( get_page_by_title("Membership")->ID ); ?>">
