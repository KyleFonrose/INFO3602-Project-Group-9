...
*/
function fitness_park_activation_notice() {
	$theme_data	 = wp_get_theme();
	echo '<div class="notice notice-success is-dismissible fitnesspark-activation-notice">';
		...
		echo '<p>';
			...
			printf( __( 'Thank you for choosing %1$s! To fully take advantage of the best our theme can offer please make sure you visit our <a href="%2$s">Welcome page</a>', 'fitness-park' ), esc_html( $theme_data->Name ), esc_url( admin_url( 'themes.php?page=about-fitnesspark' ) ) );
		echo '</p>';

		echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=about-fitnesspark' ) ) .'" class="button button-primary button-hero">';
			/* translators: %s theme name */
			printf( esc_html__( 'Get started with %s', 'fitness-park' ), esc_html( $theme_data->Name ) );
		echo '</a></p>';
