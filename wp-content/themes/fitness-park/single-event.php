				...
				<main id="main" class="site-main">
					<?php
						while ( have_posts() ) :
							...
							$relatedTestimonials = get_field('related_testimonial');
							if($relatedTestimonials){
								echo '<h3>Related Testimonial(s)</h3>';
							
								foreach($relatedTestimonials as $testimonial){
					?>
									<li><a href="<?php echo get_the_permalink($testimonial);?>">
									<?php echo get_the_title($testimonial);?>
									</a>
									</li>
